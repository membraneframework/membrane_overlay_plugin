defmodule Membrane.Overlay.Plugin.Mixfile do
  ...
  def project do
    [
      ...
      # hex
      description: "Applies static images or text overlays to video streams via Elixir Image.",
      package: package(),
  ...
  defp docs do
    [
      ...
      nest_modules_by_prefix: [Membrane.Overlay]
    ]
  end
